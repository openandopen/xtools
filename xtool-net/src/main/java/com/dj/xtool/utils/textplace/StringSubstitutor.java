...
public class StringSubstitutor {
    ...
    public static String replaceSystemProperties(final Object source) {
        return new StringSubstitutor(SystemPropertyStringLookup.INSTANCE).replace(source);
    }
    ...
    public <V> StringSubstitutor(final Map<String, V> valueMap) {
        this(MapStringLookup.on(valueMap), DEFAULT_PREFIX, DEFAULT_SUFFIX, DEFAULT_ESCAPE);
    }
    ...
    public <V> StringSubstitutor(final Map<String, V> valueMap, final String prefix, final String suffix) {
        this(MapStringLookup.on(valueMap), prefix, suffix, DEFAULT_ESCAPE);
    }
    ...
    public <V> StringSubstitutor(final Map<String, V> valueMap, final String prefix, final String suffix,
            final char escape) {
        this(MapStringLookup.on(valueMap), prefix, suffix, escape);
    }
